...
📖 Project Description
Smart Stove Monitor is a real-time safety system that uses computer vision and GPS tracking to prevent gas stove accidents. A camera continuously watches the stove. When a flame is detected AND your phone moves more than 50 meters from home, an instant alert is sent to your phone with vibration and sound. It also alerts you if no one is detected near the stove for more than 10 minutes — protecting elderly users and anyone who forgets the stove is on.
